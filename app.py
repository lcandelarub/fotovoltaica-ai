...
if documents_text:
    ...
    if query:
        ...
        client = openai.OpenAI(api_key="TU_API_KEY_AQUI")  # Reemplázala con tu clave de OpenAI
        ...
        response = client.chat.completions.create(
            model="gpt-4",
            messages=[{"role": "system", "content": "Eres un asistente experto en energía solar fotovoltaica."},
