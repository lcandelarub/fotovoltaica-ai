...
# --- INTERFAZ DE LA APP ---
st.title("🔆 Chat de Fotovoltaica AI (Depuración FORZADA)")
st.write("Haz preguntas y obtén respuestas basadas únicamente en los documentos que has subido.")
st.write("**🔎 Si la información del documento no aparece abajo después de subirlo, significa que no se está extrayendo correctamente.**")
