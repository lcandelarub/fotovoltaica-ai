...
# --- INTERFAZ DE LA APP ---
st.title("🔆 Chat de Fotovoltaica AI (Optimizado)")
    ...
    with pdfplumber.open(pdf_file) as pdf:
        for page in pdf.pages:
            ...
            if page_text:
                ...
                for i in range(0, len(words), 50):  # Fragmentos más pequeños para mejorar precisión
                    fragment = " ".join(words[i:i+50])
...
if query:
    ...
    if not knowledge_data:
        ...
        for doc in knowledge_data.values():
            for fragment in doc:
                # Priorizamos fragmentos con términos clave y números
        ...
        if not relevant_fragments:
            ...
            combined_text = "\n\n".join(relevant_fragments[:15])  # Máximo 15 fragmentos para mejor contexto
