...
# --- INTERFAZ DE LA APP ---
st.title("🔆 Chat de Fotovoltaica AI (Mejorado)")
...
if query:
    ...
    if not knowledge:
        ...
        Usa la información relevante y responde con ejemplos del documento si están disponibles.
        ...
        try:
            ...
            # Verificar si la respuesta generada es útil o si debe responder "No lo sé"
