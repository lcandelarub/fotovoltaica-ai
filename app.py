...
def download_pdfs_from_github():
    GITHUB_REPO = "https://raw.githubusercontent.com/usuario/repositorio/main/documents/"
    pdf_files = ["documento1.pdf", "documento2.pdf"]  # Lista de archivos PDF en el repo
