    ...
    if query:
        ...
        try:
            response = openai.ChatCompletion.create(
                ...
                api_key=api_key  # Se pasa la API Key en cada solicitud
            )
            ...
            st.error("❌ ERROR: La API Key de OpenAI no es válida o ha caducado.")
        except Exception as e:
            st.error(f"❌ ERROR en la consulta a OpenAI: {str(e)}")
